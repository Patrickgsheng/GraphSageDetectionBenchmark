...
flags.DEFINE_string('train_prefix', '/Users/april/Downloads/GraphSAGE_Benchmark-master/processed/10n_2a/cora/cora_100/embedding_pre/cora', 'name of the object file that stores the training data. must be specified.')
...
flags.DEFINE_string('base_log_dir', '/Users/april/Downloads/GraphSAGE_Benchmark-master/processed/10n_2a/cora/cora_100/cora_unsupervised/', 'base directory for logging and saving embeddings')
